...
\textbf{Plan Quality and Executability}: By providing senior 
	engineers \footnote{Senior Engineers defined as P3-level or above within this proposal}
	with a rigorous, research-grounded framework for
...
engineers, selected in coordination with leadership, organized into five peer
...
%\label{AppendixC}
%\input{../layer1/layer1-strategic-foundation.tex}
